export const en = {
  ...
  orders: {
    title: 'Orders',
    subtitle: 'Track pickups and reorder your usuals.',
    ...
    completedHint: 'This order was picked up.',
    ...
    emptyCurrentMessage:
      'When you place a pickup order, it will show up here.',
    emptyPreviousTitle: 'No previous orders',
    emptyPreviousMessage: 'Completed pickups will land here.',
    status: {
      pending: 'Pending',
      confirmed: 'Confirmed',
  ...
  checkout: {
    ...
    codeHint: 'You’ll get a code to show at the counter',
  ...
  confirmation: {
    ...
    heroSubtitle:
      'Show your pickup code at the counter. We’ll update this page as your order moves — no need to refresh.',
