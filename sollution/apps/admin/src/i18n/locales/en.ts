...
export const en = {
  ...
  errors: {
    ...
    loadOrder: 'Could not load this order.',
  ...
  orders: {
    ...
    detail: {
      ...
      total: 'Total',
      created: 'Created',
      updateStatus: 'Advance order',
      next: 'Next',
      flow: 'Delivery progress',
      openFullPage: 'Open full page',
    },
    page: {
      notFoundTitle: 'Order not found',
      notFoundBody: 'This order does not exist or was removed.',
    },
  },
  products: {
    title: 'Products',
  ...
  branches: {
    title: 'Branches',
    subtitle: 'Kitchens / locations — pin, coverage radius, and ETA.',
    editTitle: 'Edit branch',
    emptyTitle: 'No branches yet',
    emptyBody: 'Seed branches from scripts to get started. Create is not available in admin yet.',
    active: 'Active',
    inactive: 'Inactive',
    ...
    sections: {
      basics: 'Basics',
      basicsHint: 'Name, slug, sort order, and whether this kitchen is active.',
      address: 'Address',
      addressHint: 'Street address shown on orders and in the guest app.',
      location: 'Delivery location',
      locationHint: 'Map pin, optional coverage radius, and ETA.',
    },
    form: {
      slug: 'Slug',
      name: 'Name (EN)',
      ...
      sortOrder: 'Sort order',
      active: 'Active (shown in guest app)',
      activeLocked: 'Deactivating a branch isn’t available in admin yet.',
    },
  },
  settings: {
    title: 'Settings',
